...
const svg2 = (
  <svg
    width="352"
    className="max-w-[min(300px,25vw)]"
    viewBox="0 0 352 564"
    fill="none"
...
const svg1 = (
  ...
  >
    ...
    <line
      ...
      x2="240.543"
      y2="-0.5"
      transform="matrix(-0.593265 0.805007 -0.911135 -0.412109 318.706 367.991)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="240.543"
      y2="-0.5"
      transform="matrix(-0.593265 -0.805007 0.911135 -0.412109 173.706 562.414)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="112.331"
      y2="-0.5"
      transform="matrix(-0.729984 -0.683464 0.836332 -0.548223 319 367.991)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="112.331"
      y2="-0.5"
      transform="matrix(-0.729979 0.683469 -0.836336 -0.548217 112.999 292)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="33.5911"
      y2="-0.5"
      transform="matrix(0.714475 -0.699661 0.847339 0.531052 304 353.106)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="33.5911"
      y2="-0.5"
      transform="matrix(0.714478 0.699658 -0.847337 0.531055 22 330.388)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="98.7653"
      y2="-0.5"
      transform="matrix(0.921377 0.388671 -0.566433 0.824108 237 291.217)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="98.7655"
      y2="-0.5"
      transform="matrix(0.921381 -0.38866 0.566421 0.824116 22 330.387)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="278.87"
      y2="-0.5"
      transform="matrix(-0.219582 0.975594 -0.990593 -0.136837 237.235 291.217)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="278.87"
      y2="-0.5"
      transform="matrix(-0.219582 -0.975594 0.990593 -0.136837 176.235 561.714)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="113.202"
      y2="-0.5"
      transform="matrix(0.989383 0.14533 -0.232764 0.972533 239 291.217)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="113.202"
      y2="-0.5"
      transform="matrix(0.989383 -0.145335 0.232771 0.972531 1 307.669)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="40.1184"
      y2="-0.5"
      transform="matrix(0.648081 -0.761572 0.88639 0.462939 113 292)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="53.2958"
      y2="-0.5"
      transform="matrix(0.730946 0.682436 -0.835622 0.549305 137 261.447)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="53.2958"
      y2="-0.5"
      transform="matrix(0.730946 -0.682436 0.835622 0.549305 176 297.818)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="38.8522"
      y2="-0.5"
      transform="matrix(0.617726 0.786393 -0.900784 0.434268 215 261.447)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="59.6618"
      y2="-0.5"
      transform="matrix(0.911135 -0.412109 0.593265 0.805007 122 322.072)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="59.6618"
      y2="-0.5"
      transform="matrix(0.911135 0.412109 -0.593265 0.805007 176 297.484)"
      stroke="white"
    />
  </svg>
);
...
const svg3 = (
  ...
  >
    ...
    <line
      ...
      x2="112.811"
      y2="-0.5"
      transform="matrix(0.984808 0.173648 -0.331936 0.943302 240 340)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="112.811"
      y2="-0.5"
      transform="matrix(0.984808 -0.173648 0.33194 0.9433 1 359.589)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="36.1196"
      y2="-0.5"
      transform="matrix(0.719831 -0.69415 0.91914 0.393932 114 340.254)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="49.0756"
      y2="-0.5"
      transform="matrix(0.793801 0.608177 -0.880111 0.474769 138 315.182)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="49.0756"
      y2="-0.5"
      transform="matrix(0.793801 -0.608177 0.880111 0.474769 177 345.028)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="34.7077"
      y2="-0.5"
      transform="matrix(0.691489 0.722387 -0.929874 0.367877 216 315.182)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="57.9836"
      y2="-0.5"
      transform="matrix(0.937505 -0.347972 0.668169 0.744009 123 364.931)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="57.9836"
      y2="-0.5"
      transform="matrix(0.937505 0.347972 -0.668169 0.744009 177 344.754)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="25.5944"
      y2="-0.5"
      transform="matrix(0.273497 0.961873 -0.982157 0.188061 114 340.254)"
      stroke="white"
    />
    <line
      y1="-0.5"
      x2="27.7593"
      y2="-0.5"
      transform="matrix(-0.324216 0.945983 -0.974385 -0.224887 240 339.433)"
      stroke="white"
    />
  ...
  return (
    <>
      <div className="flex w-full h-[75vw]">
        ...
        />
        <div className="flex absolute w-full h-[75vw] bg-black opacity-75"></div>
        <div className="absolute flex w-fit text-2xl align-middle justify-center items-center mt-[25vw] flex-col left-0 right-0 m-auto">
          ...
          <button className="bg-black text-white w-full md:w-1/2 rounded-md p-2 mt-4 md:mt-5 font-semibold">
            Find jobs
          </button>
        </div>
      </div>
      ...
      <div className="flex w-full h-full justify-center align-middle flex-col p-10 gap-10">
        ...
        <div className="flex w-1/2 h-full m-auto items-center justify-center space-x-4">
          <div className="relative flex flex-col items-start justify-start">
            <h1 className="text-white absolute left-0 right-0 top-8 text-center font-semibold text-1xl">
              PT Shopee Indonesia
            </h1>
            <h1 className="text-white absolute left-0 right-0 top-16 text-center font-semibold text-1xl">
              90
            </h1>
            <h1 className="text-white absolute left-0 right-0 top-24 text-center text-1xl">
              Recruits
            </h1>
            {svg1}
          </div>
        ...
        <div className="flex flex-col md:flex-row w-full max-w-4xl">
          ...
          <div className="flex flex-col w-full md:w-1/2 p-4 md:p-8">
            ...
            <p className="text-sm md:text-base mb-6">
              Welcome to <b>AltRecruit</b>, where we believe in giving everyone
              a fair chance to prove their potential. Our mission is to create
            ...
            <div className="flex justify-end">
              <button className="bg-black text-white w-full md:w-1/2 rounded-md p-2 mt-4 md:mt-5">
                View More
              </button>
            </div>
          </div>
